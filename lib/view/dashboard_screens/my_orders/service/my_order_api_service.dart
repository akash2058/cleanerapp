...
Future<Map<String, dynamic>> fetchConfirmWarehouseupdate(
  String driverId,
  String binBookingId,
  String token,
) async {
  ...
  try {
    var response = await dio.request(
     '${AppUrl.confirmwarehousedelivery}$binBookingId',
      options: Options(
        method: 'PUT',
        headers: headers,
        followRedirects: false,
...
Future<Map<String, dynamic>> fetchbookingdamage(
  String driverId,
  String binBookingId,
  Map<String, dynamic> damages,  // Change to accept a map
  String token,
) async {
  var headers = {
    'Content-Type': 'application/json',
  ...
  var data = jsonEncode({
    "driver_id": driverId,
    "booking_id": binBookingId,
    "booking_serial_damages": damages,  // Attach the map directly
  });
  ...
  try {
    var response = await dio.request(
      '${AppUrl.bookingdamage}$binBookingId',
      options: Options(
        method: 'PUT',
        headers: headers,
        followRedirects: false,
