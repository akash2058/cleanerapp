                                ...
                                Navigator.push(
                                  ...
                                  CustomPageRoute(
                                    child: MyOrdersDropOffDetailsScreen(
                                      ...
                                      bookingid: waredata?.id.toString() ?? '', pendingamount: waredata?.pendingAmount??'', paymentoption: waredata?.paymentOption??'', paymentreceived: waredata?.paymentReceived??'', remainingamount: waredata?.remainingAmount.toString()??'', companyname: waredata?.customerCompany??'N/A', comment: waredata?.comment??'N/A', customercontact: waredata?.customerContact??'N/A',
                                    ),
                                  ),
                                );
                              }
